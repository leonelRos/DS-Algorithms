...
If there is not, add that node as the left property
  */
  ...
  bfs() {
    //traverse a tree per levels start with root then children from left to right and go on
    var node = this.root;
    var queue = [];
    var data = [];
    queue.push(node);
  ...
  DFSPreOrder() {
    //traverse the tree starting from root then the left side and then right side
    var data = []; //Stack
    var current = this.root;
  ...
  // Return the array of values
  DFSPostOrder() {
    // traverse to left side then the right side and finally adds the root.
    var data = []; //Stack
    var current = this.root;
    function traverse(node) {
      if (node.left) traverse(node.left);
  ...
  // Return the array of values
  DFSInOrder() {
    //Always return sorted list from loest to highest
    var data = []; //Stack
    var current = this.root;
    function traverse(node) {
      if (node.left) traverse(node.left);
